...
class MainTapBarController: UITabBarController {
    ...
    func configureViewController() {
        let main = templateNavigationController(unselectedImage: UIImage(systemName: "house"),
        ...
        let themes = templateNavigationController(unselectedImage: UIImage(systemName: "chart.line.uptrend.xyaxis"),
                                                  selectedImage: UIImage(systemName: "chart.line.uptrend.xyaxis"),
                                                  rootViewController: ThemesViewController())
        let account = templateNavigationController(unselectedImage: UIImage(systemName: "wallet.pass"),
                                                   selectedImage: UIImage(systemName: "wallet.pass.fill"),
                                                   rootViewController: AccountViewController())
        let setting = templateNavigationController(unselectedImage: UIImage(systemName: "ellipsis"),
                                                   selectedImage: UIImage(systemName: "ellipsis"),
                                                   rootViewController: SettingViewController())
        viewControllers = [themes,search,main,account,setting]
